...
//
addGlobalStyle('#audience-canvas {background-image: url("http://image-upload.de/image/5gDPZp/23ab0ddb5e.png") ;}');
//
addGlobalStyle('#map-canvas {background-image: url("http://image-upload.de/image/5gDPZp/23ab0ddb5e.png") ;}');
//
